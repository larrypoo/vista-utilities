KBAPXPDL ;ven/lgc - Load Distribution Global; 6/11/19 9:15am ; 6/19/19 1:17pm
 ...
 ;@ppi
START(pkgarr) ;
 ;e.g. pkgarr("nextpatch")="poo(""DG-5P3_SEQ-821_PAT-907.KIDS"")"
 ; Make sure file is in unix format
 n nxtpatch set nxtpatch=$qs(pkgarr("nextpatch"),1)
 n cmd set cmd="dos2unix /home/osehra/KIDS/"_nxtpatch
 zsystem cmd
 ;
 ;
...
GI N X,XPDSEQ,Y,Z
 ...
 ;
 ;CHANGE ven/lgc remove interactive pieces
